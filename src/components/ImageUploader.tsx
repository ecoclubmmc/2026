...
export default function ImageUploader({ currentImage, onImageUploaded, folder = 'uploads', label = 'Upload Image' }: ImageUploaderProps) {
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Priority: 1. Env Vars, 2. LocalStorage
    ...
    try {
      ...
      // Optional: Add folder if needed, but usually handled by preset
      if (folder) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-start gap-4">
        {currentImage && (
          <div className="relative group w-20 h-20 rounded-lg overflow-hidden border border-white/10 shrink-0 bg-black/40">
          ...
          `}>
            ...
            {uploading ? (
              <>
                ...
                <span className="text-sm text-emerald-500 font-medium">Uploading to Cloudinary...</span>
              </>
            ) : (
              <>

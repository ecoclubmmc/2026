        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-6">
             ...
             <div className="max-w-xl mx-auto space-y-6">
               <h2 className="text-4xl font-bold text-white mb-4">Be Part of the Change</h2>
               <p className="text-slate-300 mb-8">
                 Stay updated with our latest events, discussions, and eco-initiatives by joining our social channels.
               </p>
               ...
               <div className="flex flex-col sm:flex-row gap-4 justify-center">
                 {content.socialLinks?.whatsapp && (
                   <a 
                     ...
                     className="flex items-center justify-center gap-3 px-6 py-4 bg-[#25D366]/80 hover:bg-[#25D366] text-white rounded-2xl border border-[#25D366]/50 transition-all hover:scale-105 font-bold shadow-lg shadow-[#25D366]/20"
                   >
                 ...
                 {content.socialLinks?.instagram && (
                   <a 
                     ...
                     target="_blank" 
                     rel="noopener noreferrer"
                     className="flex items-center justify-center gap-3 px-6 py-4 bg-[#E4405F]/80 hover:bg-[#E4405F] text-white rounded-2xl border border-[#E4405F]/50 transition-all hover:scale-105 font-bold shadow-lg shadow-[#E4405F]/20"
                   >
               ...
               {(!content.socialLinks?.whatsapp && !content.socialLinks?.instagram) && (
                 <p className="text-sm text-slate-500 italic">Social links coming soon...</p>
               )}
             </div>
          </div>
